...
from config import TEST_IN_PATH, TEST_OUT_PATH, TRAIN_IN_PATH, TRAIN_OUT_PATH, TRAIN_JSON_PATH, DEV_IN_PATH, DEV_OUT_PATH, DEV_JSON_PATH, LORA_ADAPTER_PATH, MODEL_PATH, MODIFIED_MODEL_PATH, RESULTS_PATH
...
merged_model_path = MODIFIED_MODEL_PATH
...
# Speichern des gemergten Modells
